...
-- GFX account pool: pool_group='gfxtoolz' — all GFX tasks (extension + cred-fetch) share this pool.
-- Add gfxtoolz_1, gfxtoolz_2, … — tasks divide via hash; pool_role is unused (reserved).
...
('markho_runMarkhoSemrush', 'Semrush (Markhor)', 'markhor', 'http', 60, 0)
