...
echo "============================================"
echo ""
echo "Terminal 1 — SSH tunnel (keep open):"
echo "  ssh -L 3307:127.0.0.1:3306 root@74.208.99.161"
echo ""
echo "Terminal 2 — Start worker:"
echo "  export PATH=\"\$HOME/.local/go/bin:\$PATH\""
echo "  cd $INSTALL_DIR/server && ./gohttpauto"
echo ""
echo "Panel: https://panel.1clkaccess.store"
echo "Login: admin / GoHttp@2026!"
echo "============================================"
